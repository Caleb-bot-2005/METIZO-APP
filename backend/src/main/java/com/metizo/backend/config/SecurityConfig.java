package com.metizo.backend.config;

import com.metizo.backend.security.CustomUserDetailsService;
import com.metizo.backend.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    /** Frontend origins allowed to call the API (comma-separated in config). */
    @Value("${metizo.cors.allowed-origins}")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // Expose nothing sensitive; the JWT is sent by the client in the Authorization header.
